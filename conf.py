...
BLOG_AUTHOR = "George McIntosh"  # (translatable)
BLOG_TITLE = "George McIntosh' Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://georgemcintosh.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://georgemcintosh.com/"
BLOG_EMAIL = "george@georgemcintosh.com"
BLOG_DESCRIPTION = "A blog"  # (translatable)
